...
<body class="bg-primary bg-gradient text-white" >
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" name="matricula" value="<?php echo $matricula ?>">
    </div>
  </div>
  <div class="row mb-3">
  ...
  <fieldset class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputEmail3" name="telefone" value="<?php echo $telefone ?>">
    </div>
  </div>
  </fieldset>
